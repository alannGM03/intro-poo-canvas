...
class Game {
    constructor() {
        ...
        this.balls = [
            new Ball(canvas.width / 2, canvas.height / 2, 5, 1, 1, 'white'),
            new Ball(canvas.width / 2, canvas.height / 2, 10, 3, 3, 'red'),
            new Ball(canvas.width / 2, canvas.height / 2, 15, 5, 1, 'blue'),
            new Ball(canvas.width / 2, canvas.height / 2, 20, -2, -4, 'green'),
            new Ball(canvas.width / 2, canvas.height / 2, 50, 10, 10, 'yellow')
        ];

        this.paddle1 = new Paddle(0, canvas.height / 2 - 50, 10, 250, true, 'orange'); // Paleta del jugador
